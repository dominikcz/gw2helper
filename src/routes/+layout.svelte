<script>
	...
	import llzr, {_, __} from '$lib/localizer';
...
<div id="content-wrapper">
	<div id="content">
		<header>
			...
			<div class="line">
				<h1>GW2 Helper</h1>
				<small>v{data.version} <LocaleSwitch {languages} value={llzr.lang} keysOnly={true} on:locale-changed={async (v) => await llzr.changeLocale(v.detail.locale)}/></small>
			</div>
		</header>
