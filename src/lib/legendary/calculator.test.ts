...
describe('Klobjarne Geirr (103815)', () => {
    describe('baseline scenario (inventory = {}, priceMode = buy)', () => {
        const baseScenario = CalculationFor('Klobjarne Geirr');
    ...
    describe('special and edge cases: inventory', () => {
        const inventory18Scenario = CalculationFor('Klobjarne Geirr', { inventory: { 'Amalgamated Gemstone': 18 } });
        const inventoryHugeScenario = CalculationFor('Klobjarne Geirr', { inventory: { 'Amalgamated Gemstone': 9999 } });
    ...
    describe('special and edge cases: priceMode', () => {
        const buyScenario = CalculationFor('Klobjarne Geirr', { priceMode: 'buy' });
        const sellScenario = CalculationFor('Klobjarne Geirr', { priceMode: 'sell' });
...
describe('The Dreamer (30686)', () => {
    ...
    describe('baseline scenario (inventory = {}, priceMode = buy)', () => {
        const baseScenario = CalculationFor('The Dreamer');
    ...
    describe('special and edge cases: priceMode', () => {
        const buyScenario = CalculationFor('The Dreamer', { priceMode: 'buy' });
        const sellScenario = CalculationFor('The Dreamer', { priceMode: 'sell' });
    ...
    describe('special and edge cases: inventory', () => {
        const baseScenario = CalculationFor('The Dreamer');
        const inventoryScenario = CalculationFor('The Dreamer', { inventory: { 'Mystic Coin': 250 } });
...
describe('Bolt (30699)', () => {
    ...
    describe('baseline scenario (inventory = {}, priceMode = buy)', () => {
        const baseScenario = CalculationFor('Bolt');
    ...
    describe('special and edge cases: priceMode', () => {
        const buyScenario = CalculationFor('Bolt', { priceMode: 'buy' });
        const sellScenario = CalculationFor('Bolt', { priceMode: 'sell' });
    ...
    describe('special and edge cases: inventory', () => {
        const baseScenario = CalculationFor('Bolt');
        const inventoryScenario = CalculationFor('Bolt', { inventory: { 'Mystic Coin': 250 } });
